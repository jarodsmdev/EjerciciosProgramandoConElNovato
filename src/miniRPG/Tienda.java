...
public class Tienda {
    ...
    private void montarInterfaz() {
        ...
        addObjeto(panelEspada, imagenEspada, desEspada, btnEspada);
        addObjeto(panelEscudo, imagenEscudo, desEscudo, btnEscudo);
        addObjeto(panelPocion, imagenPocion, desPocion, btnPocion);
        addObjeto(panelMapa, imagenMapa, desMapa, btnMapa);
    ...
    private void addObjeto(JPanel panelObjeto, JLabel imagen, JLabel descripcion, JButton boton) {
